...
- [ ] **Step 1: Implement the smallest helpers that make Task 1 green**
...
- [ ] **Step 2: Wire AppShell to the helpers**
...
- [ ] **Step 3: Consume picker selections once in UploadWorkspace**
...
- [ ] **Step 1: Run focused and complete frontend checks**

  Run `npm test -- --run`, `npm run typecheck`, and `npm run build` from `web/`; all tests and checks must pass.

- [ ] **Step 2: Build and restart the public test service**
...
- [ ] **Step 3: Verify the deployed shell and API**
