...
data class UploadTaskEntity(
  ...
  @ColumnInfo(name = "motion_uri") val motionUri: String?,
  @ColumnInfo(name = "motion_display_name") val motionDisplayName: String?,
  @ColumnInfo(name = "motion_mime_type") val motionMimeType: String?,
  @ColumnInfo(name = "motion_size_bytes") val motionSizeBytes: Long?,
