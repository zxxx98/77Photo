...
const english = {
  ...
  'setup.title': 'Create your administrator',
  'setup.description': 'Choose the account that will manage this private library.',
  'setup.confirmPassword': 'Confirm password',
  'setup.passwordGuidance': 'Use at least 12 characters.',
  'setup.oneTimeNote': 'This one-time setup closes after the first administrator is created.',
  'setup.usernameRequired': 'Enter an administrator username.',
  'setup.usernameTooLong': 'Username must contain at most 64 characters.',
  'setup.passwordTooShort': 'Password must contain at least 12 characters.',
  'setup.passwordTooLong': 'Password must contain at most 256 characters.',
  'setup.passwordMismatch': 'The passwords do not match.',
  'setup.failed': 'The administrator could not be created. Try again.',
  ...
  'gallery.supportedStored': 'JPEG, PNG, HEIC, HEIF, MP4 or WebM · stored on your server',
  ...
  'upload.oneRequest': 'JPEG, PNG, HEIC, HEIF, MP4 or WebM · MOV pairs with a still',
  ...
  'viewer.openInAmap': 'Open in Amap',

  'map.title': 'Map',
  'map.loading': 'Loading the map…',
  'map.yearFilter': 'Filter by year',
  'map.allYears': 'All',
  'map.olderYears': 'Earlier',
  'map.inThisArea': '{count} in this area',
  'map.atThisPlace': '{count} at this place',
  'map.backToArea': 'Back to this area',
  'map.coverage': '{located} of {total} photos have a location',
  'map.nothingHere': 'No photos here. Pan or zoom out to look around.',
  'map.loadFailed': 'Unable to load the map. Try again.',
  'map.areaFailed': 'Unable to load the photos in this area.',
  'map.openFailed': 'Unable to open this photo.',
  'map.showPhotos': 'Show photos',
  'map.hidePhotos': 'Hide photos',
  'map.photoCount': '{count} photos',
  'map.openPhoto': 'Open photo',
  'map.zoomIn': 'Zoom in',
  'map.zoomOut': 'Zoom out',
  'map.disabledTitle': 'The map is not set up yet',
  'map.disabledAdmin': 'Create a browser key in the Tianditu console, set it as PHOTO_MAP_TIANDITU_KEY on the server, then restart 77Photo.',
  'map.disabledMember': 'Ask the administrator to turn on the map.',
  'map.noLocationsTitle': 'No photos with a location yet',
  'map.noLocationsAdmin': 'Photos added before the map existed need one rescan. Run “Rescan files” in Settings to read their locations.',
  'map.noLocationsNote': 'Some phones remove the location when a photo is shared or uploaded.',
  'map.openSettings': 'Open settings',
  'map.emptyTitle': 'Your library is empty',
  'map.emptyDescription': 'Photos with a location appear here after you upload them.',
  'map.tilesFailedAdmin': 'The base map could not load. Check the Tianditu key, its allowed origins and today’s quota.',
  'map.tilesFailedMember': 'The base map is temporarily unavailable.',
  ...
  'settings.scanPhase.thumbnails': 'Generating thumbnails, please wait…',
...
const chinese: Record<TranslationKey, string> = {
  ...
  'setup.firstRun': '首次使用',
  'setup.title': '创建管理员',
  'setup.description': '设置用于管理这个私人图库的首个账号。',
  'setup.confirmPassword': '确认密码',
  'setup.passwordGuidance': '密码至少 12 个字符。',
  'setup.oneTimeNote': '首个管理员创建后，此初始化入口将自动关闭。',
  'setup.usernameRequired': '请输入管理员用户名。',
  'setup.usernameTooLong': '用户名最多 64 个字符。',
  'setup.passwordTooShort': '密码至少 12 个字符。',
  'setup.passwordTooLong': '密码最多 256 个字符。',
  'setup.passwordMismatch': '两次输入的密码不一致。',
  'setup.failed': '无法创建管理员，请重试。',
  'setup.creating': '正在创建管理员…',
  'setup.create': '创建管理员',
  ...
  'gallery.supportedStored': 'JPEG、PNG、HEIC、HEIF、MP4 或 WebM · 存储在你的服务器上',
  ...
  'upload.oneRequest': 'JPEG、PNG、HEIC、HEIF、MP4 或 WebM · MOV 会与同名照片配对',
  'upload.waiting': '等待中',
  'upload.uploaded': '已上传',
  ...
  'viewer.openInAmap': '在高德地图中打开',

  'map.title': '地图',
  'map.loading': '正在加载地图…',
  'map.yearFilter': '按年份筛选',
  'map.allYears': '全部',
  'map.olderYears': '更早',
  'map.inThisArea': '此区域 {count} 张',
  'map.atThisPlace': '该地点 {count} 张',
  'map.backToArea': '返回此区域',
  'map.coverage': '{total} 张照片中 {located} 张有位置',
  'map.nothingHere': '这里没有照片，拖动或缩小地图看看。',
  'map.loadFailed': '无法加载地图，请重试。',
  'map.areaFailed': '无法加载此区域的照片。',
  'map.openFailed': '无法打开这张照片。',
  'map.showPhotos': '展开照片',
  'map.hidePhotos': '收起照片',
  'map.photoCount': '{count} 张照片',
  'map.openPhoto': '打开照片',
  'map.zoomIn': '放大',
  'map.zoomOut': '缩小',
  'map.disabledTitle': '地图尚未启用',
  'map.disabledAdmin': '在天地图控制台申请「浏览器端」key，将它设置为服务器环境变量 PHOTO_MAP_TIANDITU_KEY，然后重启 77Photo。',
  'map.disabledMember': '请联系管理员启用地图。',
  'map.noLocationsTitle': '还没有带位置的照片',
  'map.noLocationsAdmin': '地图上线前加入的照片需要重新扫描一次。到设置中执行「重新扫描文件」即可读取位置。',
  'map.noLocationsNote': '部分手机在分享或上传照片时会去掉位置信息。',
  'map.openSettings': '打开设置',
  'map.emptyTitle': '图库还是空的',
  'map.emptyDescription': '上传带位置的照片后，它们会出现在这里。',
  'map.tilesFailedAdmin': '底图无法加载。请检查天地图 key、白名单设置和当日配额。',
  'map.tilesFailedMember': '地图底图暂时无法加载。',
  ...
  'settings.scanPhase.thumbnails': '正在生成缩略图，请稍候…',
