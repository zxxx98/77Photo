...
const english = {
  ...
  'folders.emptyEyebrow': 'A fresh space',
  'folders.emptyTitle': 'Start organizing here',
  'folders.emptyDescription': 'Upload photos or create a folder to give these memories a place of their own.',
  'folders.emptyUpload': 'Upload photos',
  'folders.emptyCreate': 'New folder',
...
const chinese: Record<TranslationKey, string> = {
  ...
  'folders.emptyEyebrow': '一处新空间',
  'folders.emptyTitle': '从这里开始整理',
  'folders.emptyDescription': '上传照片，或新建文件夹，把这一段回忆安放好。',
  'folders.emptyUpload': '上传照片',
  'folders.emptyCreate': '新建文件夹',
